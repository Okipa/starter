...
@section('template')
    <h1>
        ...
        @if ($dynamicPageBlock)
            @lang('admin.title.orphan.edit', ['entity' => __('dynamic-pages.entities.dynamicPageBlocks'), 'detail' => __(config('dynamic-pages.blocks.h1.name')) ])
        @else
   ...
   <div class="card">
       ...
       <div class="card-body">
           <form action="{{ $dynamicPageBlock ? route('dynamicPageBlock.h1.update', [ $dynamicPage, $dynamicPageBlock ]) : route('dynamicPageBlock.h1.store', $dynamicPage) }}" method="POST">
               @csrf
